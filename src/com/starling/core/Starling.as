    ...
    public class Starling extends EventDispatcher
    {
        ...
        private function initializeRoot():void
        {
            if (mRoot == null)
            {
                ...
                dispatchEventWith(com.starling.events.Event.ROOT_CREATED, false, mRoot);
            }
        }
        ...
        public function stopWithFatalError(message:String):void
        {
            ...
            dispatchEventWith(com.starling.events.Event.FATAL_ERROR, false, message);
        }
        ...
        private function onKey(event:KeyboardEvent):void
        {
            ...
            var keyEvent:com.starling.events.KeyboardEvent = new com.starling.events.KeyboardEvent(
        ...
        public function showStatsAt(hAlign:String="left", vAlign:String="top", scale:Number=1):void
        {
            if (mContext == null)
            {
                ...
                addEventListener(com.starling.events.Event.ROOT_CREATED, onRootCreated);
            }
            else
            {
            ...
            function onRootCreated():void
            {
                ...
                removeEventListener(com.starling.events.Event.ROOT_CREATED, onRootCreated);
            }
        }
